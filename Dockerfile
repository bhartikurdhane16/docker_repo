...
VOLUME ["/myvolume"]
#sudo docker run -it --name container2 --privileged=true --volumes-from mynewcont ubuntu /bin/bash -----here we created container2 with shared volume from mynewcontainer, ie my newcont already have volume and 
